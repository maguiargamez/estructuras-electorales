    ...
    <div id="kt_app_content_container" class="app-container">
        ...
        <div class="card card-custom card-flush h-xl-100">
            ...
            <div class="card-body pt-2">
                ...
                <div class="row mb-6">
                    <label class="col-lg-2 col-form-label required fw-semibold fs-6">Tipo de apoyo</label>
                    <div class="col-lg-10">
                        <div class="row">
                            ...
                            <div class="input-group mb-5">
                                ...
                                <x-select wire:model="structurePromotedSupports.support_type_id" :options="$supportTypes" placeholder="Seleccionar" id="structurePromotedSupports.support_type_id"></x-select>
                                @error('structurePromotedSupports.support_type_id')
                    ...
                    <div class="col-lg-10">
                        <div class="row">
                            <div class="input-group mb-5">
                                ...
                                <input wire:model="structurePromotedSupports.description" type="text" class="form-control @error('structurePromotedSupports.description') is-invalid @enderror">  
                                
                                @error('structurePromotedSupports.description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                @enderror
                    ...
                    <table class="table table-bordered align-middle table-row-gray-400 fs-6 gy-3" id="kt_table_widget_4_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px sorting_disabled" rowspan="1" colspan="1">APOYO</th>
                                <th class="min-w-100px sorting_disabled" rowspan="1" colspan="1">DESCRIPCIÓN</th>
