...
<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
    ...
    <div class="menu-item pt-5">
        ...
        <div class="menu-content">
            <span class="menu-heading fw-bold text-uppercase fs-7">Estructura electoral</span>
        </div>
        <!--end:Menu content-->
    </div>
        ...
        <!--
        <div class="menu-item">
            <a class="menu-link" href="{{ route('elecicones.index') }}">
                <span class="menu-icon">
                    <span class="svg-icon svg-icon-2">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="menu-item">
        <!--begin:Menu link-->
        <a class="menu-link" href="{{ route('estructura.index') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/coding/cod003.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="menu-item">
        <a class="menu-link" href="{{ route('coordinador-distrital.index') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="menu-title">Coordinadores distritales</span>
        </a>
    </div>

    <div class="menu-item">
        <a class="menu-link" href="{{ route('coordinador-municipal.index') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.28548 15.0861C7.34369 13.1814 9.35142 12 11.5304 12H12.4696C14.6486 12 16.6563 13.1814 17.7145 15.0861L19.3493 18.0287C20.0899 19.3618 19.1259 21 17.601 21H6.39903C4.87406 21 3.91012 19.3618 4.65071 18.0287L6.28548 15.0861Z" fill="currentColor"></path>
        ...
        <span class="menu-title">Coordinadores municipales</span>
        </a>
    </div>

    <div class="menu-item">
        <a class="menu-link" href="{{ route('promotores.index') }}">
            ...
            <span class="menu-title">Promotores</span>
    ...
    <div class="menu-item pt-5">        
        <div class="menu-content">
            <span class="menu-heading fw-bold text-uppercase fs-7">Promovidos</span>
        </div>
    </div>

    <div class="menu-item">
        <a class="menu-link" href="{{ route('promovidos.index') }}">
            <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="menu-title">Promovidos</span>        
        </a>
    </div>

    <div class="menu-item">
        <a class="menu-link" href="{{ route('promovidos.simpatizantes') }}">
            <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.7 4.19995L4 6.30005V18.8999L8.7 16.8V19L3.1 21.5C2.6 21.7 2 21.4 2 20.8V6C2 5.4 2.3 4.89995 2.9 4.69995L8.7 2.09998V4.19995Z" fill="currentColor"></path>
            ...
            <span class="menu-title">Simpatizantes</span>        
        </a>
    </div>
    ...
    <div class="menu-item pt-5">        
        <div class="menu-content">
            <span class="menu-heading fw-bold text-uppercase fs-7">Mantenimiento</span>
        </div>
    </div>
