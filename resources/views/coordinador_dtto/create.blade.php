...
@section('breadcrumbs')
	...
	<li class="breadcrumb-item text-muted">Registro de coordinador distrital</li>
@endsection

@section('buttons')
	<a href="{{ url('coordinador-distrital') }}" class="btn btn-sm btn-dark"><i class="fas fa-arrow-left"></i>Regresar</a> 
    <button id="btn-create-coordinador-dtto" class="btn btn-sm btn-primary btn-create-coordinador-dtto"><i class="far fa-save"></i> Guardar</button>
@endsection
...
@section('js')
	<script src="{{ asset('views/coordinadores/distrital/create.js') }}"></script>
