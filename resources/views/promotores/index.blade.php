@extends('layouts.app-js')
	...
	@section('buttons')
		...
		<a href="{{ route('promotores.create') }}" type="button" class="btn btn-sm btn-primary">
            <i class="fa-solid fa-plus"></i> Registrar Promotor
        </a>
				...
				<div class="collapse" id="kt_advanced_search_form">
					...
					<div class="row g-8 mb-8">
						...
						<div class="col-xxl-12">
							<label class="fs-6 form-label fw-bold text-dark">Coordinadores</label>
							<select class="form-select form-select-solid" id="structure_coordinator_id" name="structure_coordinator_id" data-control="select2" data-placeholder="-- Seleccionar --" data-hide-search="true"></select>
						</div>
	        ...
	        <div class="card-body pt-2">            
	            <div id="kt_file_manager_list_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"> 
	            	<div class="table-responsive">
		                <table id="tbl-promotores" class="table table-bordered align-middle table-row-gray-400 fs-6 gy-3" width="100%">
		                    <thead>
	...
	@section('js')
		...
		<script src="{{ asset('views/promotores/index.js') }}"></script> 
