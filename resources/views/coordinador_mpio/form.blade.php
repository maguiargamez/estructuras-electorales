    ...
    <div class="card-body">    	
    	<div class="row">
    		...
    		<div class="col-md-12">
    			...
    			<div class="row">
    				<h2 class="mb-5">Datos del coordinador distrital</h2>
    				<div class="row mb-7">
						...
						<div class="col-md-4 col-xl-3" id="dvMunicipality" style="display: none;">
							<div class="position-relative d-flex align-items-center">
								...
								<select class="form-select ps-12 removeIsInvalidSelect" aria-label="Municipio" id="municipality_id" name="municipality_id"></select>
							</div>
						</div>
					</div>
    			</div>
    			...
    			<div class="row">    
					<h2 class="mb-5">Datos del coordinador municipal</h2>
	    		...
	    		<div class="row">
	    			<h2 class="mb-5">Medios de contacto del coordinador municipal</h2>
