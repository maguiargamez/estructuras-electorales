...
@section('buttons')
	<a href="{{ route('coordinador-municipal.create') }}" type="button" class="btn btn-sm btn-primary">
        <i class="fa-solid fa-plus"></i>   
        Registrar coordinador municipal
    </a>
@endsection
...
@section('js')  
	...
	<script src="{{ asset('views/coordinadores/municipal/index.js') }}"></script> 
@endsection
