...
function load_coordinadores()
 {
    $.ajax({
        type: 'GET',
        url: vuri + '/coordinador-distrital/results',
        dataType: "JSON",
        data: {
            method: 'get'
        },
        success: function(vresponse, vtextStatus, vjqXHR) {
            ...
            for ( vi=0; vi < vrespuesta.length; vi++ ) {
                ...
                vhtml+='                    <a href="'+ vuri + '/coordinador-distrital/'+ vrespuesta[vi].id +'/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">';
