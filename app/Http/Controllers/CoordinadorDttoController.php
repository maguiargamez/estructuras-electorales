...
class CoordinadorDttoController extends Controller
{

	public function index()
     {
        return view('coordinador_dtto.index');
     }

	public function create()
     {
        return view('coordinador_dtto.create');
     }   
    ...
    public function store(Request $vrequest)
     {
        ...
        $vflcoordinatorDtto = new clsStructureCoordinators;
        ...
        try {
                ...
                if( !empty($vdatosSection) )
                {
                    ...
                    if ( empty($queryIne) ) {
                        ...
                        $vdatosCoordinator['position_id'] = 2;
                        $vdatosCoordinator['structure_coordinator_id'] = 1;
                        ...
                        $vflcoordinatorDtto->fill($vdatosCoordinator)->save();

                        $vresponse=['icono'=>'success', 'codigo'=> 1, 'mensaje'=> 'El Coordinador Distrital fue insertado exitosamente.'];
                        unset($vflmember, $vflcoordinatorDtto); 
                    }
                    else {
    ...
    public function edit($id)
     {
        return view('coordinador_dtto.edit', ['id'=>$id]);
     }
    ...
    public function update(Request $vrequest)
     {
       /**
         * 28 de Junio de 2023
         * Metodo para actualizar los datos de un coordinador distrital.
         * */
        ...
        $vdatosSection = clsStructure::queryToDBSelect(['section'=>$vrequest->section])->first();
        $vflcoordinatorDtto = clsStructureCoordinators::find($id_coordinador);
        $vflmember = clsMembers::find($vflcoordinatorDtto->member_id);
        ...
        try {
                DB::beginTransaction();
                    ...
                    if( !empty($vdatosSection) )
                    {
                        $queryIne=clsMembers::queryToDB(['clave_elector' => $vrequest->electoral_key, 'id_promovidoUPD'=>$vflcoordinatorDtto->member_id])->first();
                        if ( empty($queryIne) ) {
                                ...
                                $vresponse=['icono'=>'success', 'codigo'=> 1, 'mensaje'=> 'El Coordinador Distrital fue actualizado exitosamente.'];
                                unset($vflmember, $vflcoordinatorDtto); 
    ...
    public function getResult(Request $vrequest)
     {
        // Descripción: Función para consultar los coordinadores distritales
        // Creación: Miercoles, 28 de Juio de 2023
        // Versión: 1.0.0
