...
class StructureMunicipalitySeeder extends Seeder
{
    /**
    ...
    {
        //Structure::truncate();
        $csvData = fopen(base_path('database/csv/structuresMunicipality.csv'), 'r');
        $titleRow = true;
        ...
        while (($data = fgetcsv($csvData, 555, ',')) !== false) {
            if (!$titleRow) {
                ...
                if(!in_array($section, $arraySections)){
                    ...
                    $promoters= StructureCoordinator::where('position_id', 10)->where('section', $structure['section'])->get();
